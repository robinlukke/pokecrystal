...
FalknerGroup:
	...
	db  7, HOOTHOOT,   PECK, MUD_SLAP, NO_MOVE, NO_MOVE
...
BugsyGroup:
	...
	db 14, PINECO,     LEECH_LIFE, STRING_SHOT, SPIKES, EXPLOSION
	db 14, SHUCKLE,    WRAP, ROCK_THROW, REST, TOXIC
...
MortyGroup:
	...
	db 21, MISDREAVUS, LICK, SPITE, MEAN_LOOK, CURSE
...
PryceGroup:
	...
	db 27, SNEASEL,    FAINT_ATTACK, ICY_WIND, AURORA_BEAM, METAL_CLAW
