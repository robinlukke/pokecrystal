...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, INDOOR, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_POND
	map ViridianForestGateNorth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateSouth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
