...
Route34_MapEvents:
	...
	warp_event 13, 14, DAY_CARE, 1
	warp_event 13, 15, DAY_CARE, 2
	warp_event 15, 15, DAY_CARE, 3
	...
	bg_event 12, 13, BGEVENT_READ, DayCareSign
	...
	object_event  8, 15, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, OfficerKeithScript, -1
	...
	object_event 12, 15, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DayCareManScript_Outside, EVENT_DAY_CARE_MAN_ON_ROUTE_34
