...
Route2_MapEvents:
	...
	warp_event  3, 33, VIRIDIAN_FOREST_GATE_SOUTH, 3
	...
	bg_event  5,  8, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event  0,  8, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event 10, 34, BGEVENT_ITEM, Route2HiddenFullRestore
	...
	object_event 19, 24, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2DireHit, EVENT_ROUTE_2_DIRE_HIT
	object_event 14, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2MaxPotion, EVENT_ROUTE_2_MAX_POTION
	...
	object_event 15, 12, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
